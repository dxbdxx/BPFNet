...
class CropAndResize(nn.Module):
    ...
    def forward(self, image, boxes, ind_boxes):
        return CropAndResizeFunction.apply(image, boxes, ind_boxes, self.crop_height, self.crop_width, self.extrapolation_value)
